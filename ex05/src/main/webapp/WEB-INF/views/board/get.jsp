  ...
  <div class="col-lg-12">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class='uploadResult'> <!-- 첨부파일의 목록 -->
          <ul>
          </ul>
        </div>
      </div>
...
$(document).ready(function(){
    ...
    function showReplyPage(replyCnt){
      ...
      for(var i = startNum ; i <= endNum; i++){ // 1~10
	...
	$(".chat").on("click", "li",  function(e){
		...
		replyService.get(rno, function(reply){
			...
			modalInputReplyDate.val(replyService.displayTime(reply.replyDate)).attr("readonly", true);
...
/* 	console.log("================");
	...
	replyService.getList({bno:bnoValue, page:1}, function(list){
		for(var i = 0, len=list.length||0; i<len; i++){ // list.length||0 -> list.length가 0이면 0이들어감
			console.log(list[i]);
		}
	}); */
